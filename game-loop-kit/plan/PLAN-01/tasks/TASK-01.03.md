# TASK-01.03 — LEVEL-C 규칙 변주

- 부모: PLAN-01 (가설 H-01) · 상태: `todo`
- **변주 조건:** 수치=\<변경\> · 구조/인원=기준  → `levels/LEVEL-C/build.md`
...
### TICKET-01.03.01 — 레벨 뼈대 구성   · status: `todo` · deps: TICKET-01.01.04 (대조군 먼저)
...
- **산출물:** 레벨 배치 · `levels/LEVEL-C/build.md` 갱신

### TICKET-01.03.02 — 메카닉 배선   · status: `todo` · deps: 01.01.01
...
### TICKET-01.03.03 — 측정 로그 심기   · status: `todo` · deps: 01.01.02
- **목표:** FUN-HYPOTHESIS의 **자동 지표**를 수집 가능하게
- **구조 수용:** `.verse`에 `[M]` 태그 Print가 지표별로 존재
- **행동 수용:** PIE 1회 → `get_editor_log`에 지표 라인 **전부** 출력됨
- **산출물:** Verse 로그 코드 · `levels/LEVEL-C/metrics.md` 표 준비

### TICKET-01.03.04 — 자동 실행 & 집계   · status: `todo` · deps: 01.01.03
